...
class MarketMaker:
    ...
    def _build_quote(self, option: BinaryOption, counterparty_id: int) -> Quote:
        ...
        if self._unopposed():
            ...
            # exchange then splits the order. One penny inside wins the whole thing. Fair value still
            # bounds the quote, so this only steps in where the penny is on the right side of theo.
